...
import { CacheProviderRegistry, CacheProvider } from "@quartz/lib/cache-provider";
...
interface QuartzPluginOptions { plugins?: (new (...args: unknown[]) => BasePlugin)[] }

type QuartzClientOptions = QuartzReryOptions & QuartzPluginOptions & { cacheProvider: CacheProvider }
